<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master"
   AutoEventWireup="true" CodeFile="FuentesNutXal.aspx.cs" Inherits="FuentesNutXal" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_Body" runat="server">
    ...
    <div class="admin-cnt-body">
            ...
            <div id="cnt-listview">
                <div>
                    ...
                    <asp:UpdatePanel ID="updPanelMain" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="btnCrearUsuario">
                                <a id="callThickbox1" name="callThickbox1" class="thickbox" runat="server" title="&nbsp;"
                                    href="EditFuentesDataRow.aspx?Mode=Insert&TB_iframe=true&MODAL=true&height=200&width=500">
                                    <div style="width: 130px;">
                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/App_Themes/Default/Images/add_16.png"
                                            Style="float: left;" />
                                        &nbsp;<span class="lbl-btnCrearUsuario">Agregar Fuente</span>
                                    </div>
                                </a>
                            </div>
                       <!--BOTON REFRESH-->
                       ...
                       <!--LISTVIEW-->
                       <asp:ListView ID="lvGeneric" runat="server" DataSourceID="odsFuentes" OnItemDataBound="ItemDataBound_lvGeneric"
                                ...
                                <div style="clear:both;">
                                    ...
                                    <table id="tbGeneric" runat="server" class="datatable" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <th>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Sort" CommandArgument="fntID" Text="Codigo" />
                                            </th>
                                            <th>
                                                <asp:LinkButton ID="LinkButton4" runat="server" CommandName="Sort" CommandArgument="Nombre" Text="Nombre" />
                                            </th>
                                            <th>
                                                <asp:LinkButton ID="LinkButton8" runat="server" CommandName="Sort" CommandArgument="Activo" Text="Estado" />
                                            </th>
                                        </tr>
                                    ...
                                    <div id="lv-pager">
                                        <div>   
                                            <asp:DataPager ID="pagerBotoom" runat="server" PageSize="10">
                                                <Fields>
                           ...
                           <ItemTemplate>
                               <tr id="item" runat="server" class='<%#Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                   <td align="center">
                                       <a id="callThickbox1" name="callThickbox1" class="thickbox" runat="server" title ="&nbsp;"
                                           href='<%# Eval ("FntID","EditFuentesDataRow.aspx?Mode=update&id={0}&TB_iframe=true&MODAL=true&height=250%width=550") %>'>
                                           <img src="../../../App_Themes/Default/Images/edit_16.png" style="float: left; padding: 3px; border: solid 1px transparent;" title="Editar Fuente" alt="" />
                                       </a>
                                       <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/App_Themes/Default/Images/delete.png"
                                           CommandName="Eliminar" CommandArgument='<%#Eval("FntID") %>' CausesValidation="false"
                                           ToolTip="Eliminar Fuente" Style="padding: 3px; border: solid 1px transparent;" />
                                       ...
                                       <asp:Panel ID="PNL" runat="server" Style="display: none; border:solid 3px #6084a8; background-color: white; width: 400px; padding: 2px; ">
                                           <div runat="server" id="headerConfirm">
                                               <div style="background-color: #8aabcd; color: white; padding: 4px; font-size: 14px;font-family: Century Gothic,Vardana,Arial;">
                                                   <b>ELIMINAR Fuente</b>
                                               </div>
                                               <div style="padding: 5px;">
                                                   <h4>
                                                       ¿Seguro que desea ELIMINAR la fuente " <span style="color:green;"><%# Eval("Nombre") %></span>"?
                                                   </h4>
                                               </div>
                                   ...
                                   <td style="width: 70px; text-align: center;">
                                            <img src="../../../App_Themes/Default/Images/flags/flag_green.png" visible="false"
                                                runat="server" id="imgActivo" title="Fuente Activa" />
                                            <img src="../../../App_Themes/Default/Images/flags/flag_red.png" visible="false"
                                                runat="server" id="imgInactivo" title="Fuente Inactiva" />
                                   </td>
                               </tr>
                           </ItemTemplate>
                           <EmptyItemTemplate>
                               <div style="padding: 4px; border: solid 1px #86a6ca;">
                                   No existen Fuentes Definidas!
                               </div>
                           </EmptyItemTemplate>
                            </asp:ListView>
        ...
        <asp:ObjectDataSource ID="odsFuentes" runat="server" OldValuesParameterFormatString="original_{0}"
            OnSelecting="odsFuentes_Selecting" SelectMethod="Search" TypeName="Interfood.Business.FuenteBus">
            <SelectParameters>
