<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master"
    AutoEventWireup="true" CodeFile="TipoDeAlimentoList.aspx.cs" Inherits="TipoDeAlimentoList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_Body" runat="Server">
    ...
    <div class="admin-cnt-body">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="btnCrearUsuario">
                                <a id="callThickbox1" name="callThickbox1" class="thickbox" runat="server" title="&nbsp;"
                                    href="EditTipoDeAlimentoDataRow.aspx?Mode=Insert&TB_iframe=true&MODAL=true&height=250&width=550">
                                    <div style="width:190px;"> <asp:Image ID="Image2" runat="server" ImageUrl="~/App_Themes/Default/Images/add_16.png"
                                            Style="float: left;" />
                                        &nbsp;<span class="lbl-btnCrearUsuario">Agregar Tipo de Alimento</span>
                                    </div>
                                </a>
                            </div>
                            <!-- BOTON REFRESH -->
                            ...
                            <!-- LISTVIEW  -->
                            <asp:ListView ID="lvGeneric" runat="server" DataSourceID="odsTipoDeAlimentos" OnItemDataBound="ItemDataBound_lvGeneric" OnItemCommand="ItemCommand_lvGeneric">
                                <LayoutTemplate>
                                    <div style="clear: both;">
                                        ...
                                        <table id="tbGeneric" runat="server" class="datatable" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Sort" CommandArgument="TipoDeAlimentoID"
                                                        Text="#" />
                                                </th>
                                                <th>
                                                    <asp:LinkButton ID="LinkButton4" runat="server" CommandName="Sort" CommandArgument="TipoDeAlimento"
                                                        Text="Tipo de Alimento" />
                                                </th>
                                                <th>
                                                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="Sort" CommandArgument="OrdenDeVisualizacion"
                                                        Text="Orden de Visualización" />
                                                </th>
                                                 <th style="width: 40px;">
                                                    <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Sort" CommandArgument="Estado"
                                                        Text="Estado" />
                                                </th>
                                            </tr>
                                ...
                                <ItemTemplate>
                                    <tr id="item" runat="server" class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                        <td align="center">
                                            <a id="callThickbox1" name="callThickbox1" class="thickbox" runat="server" title="&nbsp;"
                                                href='<%# Eval("TipoDeAlimentoId","EditTipoDeAlimentoDataRow.aspx?Mode=update&id={0}&TB_iframe=true&MODAL=true&height=250&width=550") %>'>
                                                <img src="../../../App_Themes/Default/Images/edit_16.png" style="float: left; padding: 3px;
                                                    border: solid 1px transparent;" title="Editar Tipo de Alimento" alt="" />
                                            </a>
                                            <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/App_Themes/Default/Images/delete.png"
                                                CommandName="Eliminar" CommandArgument='<%# Eval("TipoDeAlimentoId") %>' CausesValidation="false"
                                                ToolTip="Eliminar Tipo de Alimento" Style="padding: 3px; border: solid 1px transparent;" />
                                            ...
                                            <asp:Panel ID="PNL" runat="server" Style="display: none; border: solid 3px #6084a8;
                                                ...
                                                <div runat="server" id="headerConfirm">
                                                    <div style="background-color: #8aabcd; color: White; padding: 4px; font-size: 14px;
                                                        ...
                                                        <b>ELIMINAR Tipo de Alimento</b>
                                                    </div>
                                                    <div style="padding: 5px;">
                                                        <h4>
                                                            ¿Seguro que desea ELIMINAR el Tipo de Alimento "<span style="color: Green;"><%# Eval("TipoDeAlimento") %></span>"?
                                                        </h4>
                                                    </div>
                                        ...
                                        <td style="width:70px;text-align:center;">
                                            <img src="../../../App_Themes/Default/Images/flags/flag_green.png" visible="false" runat="server" id="imgActivo" title="Tipo de Alimento Activo" />
                                            <img src="../../../App_Themes/Default/Images/flags/flag_red.png" visible="false" runat="server" id="imgInactivo" title="Tipo de Alimento Inactivo"/>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                                <EmptyItemTemplate>
                                    <div style="padding: 4px; border: solid 1px #86a6ca;">
                                        No existen Tipo de Alimentos definidos!
                                    </div>
                                </EmptyItemTemplate>
                            </asp:ListView>
        ...
        <asp:ObjectDataSource ID="odsTipoDeAlimentos" runat="server" OldValuesParameterFormatString="original_{0}"
            OnSelecting="odsNutrientes_Selecting" SelectMethod="Search" 
                TypeName="Interfood.Business.TipoDeAlimentosBus">
            <SelectParameters>
