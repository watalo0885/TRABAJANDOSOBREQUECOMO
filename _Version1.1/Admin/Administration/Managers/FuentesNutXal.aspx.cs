...
public partial class FuentesNutXal : System.Web.UI.Page
{

    AlimentoNutrienteBus busNutrientes = new AlimentoNutrienteBus();
    AlimentoNutrienteEntityFilter filterNutrientes = new AlimentoNutrienteEntityFilter();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            Menu1.nameSelectedOption = "GOTO_FUENTENUTALI";
    ...
    protected void ItemCommand_lvGeneric(object sender, ListViewCommandEventArgs e)
    {
        try
        {
            string FuenteID = e.CommandArgument.ToString();
            ...
            if (e.CommandName.ToString().ToUpper() == "ELIMINAR")
            {
                ...
                //--------------------------------------------------
                filterNutrientes.OpeFntID = Helpers.Operators.Operadores_VarChar.Igual;
                filterNutrientes.FntID = FuenteID;
                DataTable dtControl = busNutrientes.Search(filterNutrientes);
                if (dtControl != null && dtControl.Rows.Count > 0)
                {
                    ltrMessage.Text = "<span style='color:red;'>No es posible eliminar la Fuente ya que tiene Nutrientes asignados!</span>";
                ...
                ltrMessage.Text = "<span style='color:red;'>Fuente eliminada correctamente!</span>";
                ltrMessage.Visible = true;
    ...
    #region ODS
    protected void odsFuentes_Selecting(object sender, ObjectDataSourceSelectingEventArgs e)
    {
