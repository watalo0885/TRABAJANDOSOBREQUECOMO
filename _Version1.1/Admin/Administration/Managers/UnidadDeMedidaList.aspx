<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MainMaster.master"
    AutoEventWireup="true" CodeFile="UnidadDeMedidaList.aspx.cs" Inherits="UnidadDeMedidaList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_Body" runat="Server">
    ...
    <div class="admin-cnt-body">
                        ...
                        <ContentTemplate>
                            ...
                            <div class="btnCrearUsuario">
                                <a id="callThickbox1" name="callThickbox1" class="thickbox" runat="server" title="&nbsp;"
                                    href="EditUnidadDeMedidaDataRow.aspx?Mode=Insert&TB_iframe=true&MODAL=true&height=200&width=500">
                                    <div style="width: 200px;">
                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/App_Themes/Default/Images/add_16.png"
                                            Style="float: left;" />
                                        &nbsp;<span class="lbl-btnCrearUsuario">Agregar Unidad de Medida</span>
                                    </div>
                                </a>
                            </div>
                            <!-- BOTON REFRESH -->
                            ...
                            <!-- LISTVIEW  -->
                            <asp:ListView ID="lvGeneric" runat="server" DataSourceID="odsUnidadDeMedida" OnItemDataBound="ItemDataBound_lvGeneric"
                                    ...
                                    <div style="clear: both;">
                                        ...
                                        <table id="tbGeneric" runat="server" class="datatable" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <th>
                                                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Sort" CommandArgument="udmid"
                                                        Text="#" />
                                                </th>
                                                <th>
                                ...
                                <ItemTemplate>
                                    <tr id="item" runat="server" class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                        <td align="center">
                                            <a id="callThickbox1" name="callThickbox1" class="thickbox" runat="server" title="&nbsp;"
                                                href='<%# Eval("UDMid","EditUnidadDeMedidaDataRow.aspx?Mode=update&id={0}&TB_iframe=true&MODAL=true&height=250&width=550") %>'>
                                                <img src="../../../App_Themes/Default/Images/edit_16.png" style="float: left; padding: 3px;
                                                    border: solid 1px transparent;" title="Editar Unidad de Medida" alt="" />
                                            </a>
                                            <asp:ImageButton ID="btnDelete" runat="server" ImageUrl="~/App_Themes/Default/Images/delete.png"
                                                CommandName="Eliminar" CommandArgument='<%# Eval("UDMid") %>' CausesValidation="false"
                                                ToolTip="Eliminar Unidad de Medida" Style="padding: 3px; border: solid 1px transparent;" />
                                            ...
                                            <asp:Panel ID="PNL" runat="server" Style="display: none; border: solid 3px #6084a8;
                                                ...
                                                <div runat="server" id="headerConfirm">
                                                    <div style="background-color: #8aabcd; color: White; padding: 4px; font-size: 14px;
                                                        ...
                                                        <b>ELIMINAR Unidad de Medida</b>
                                                    </div>
                                                    <div style="padding: 5px;">
                                                        <h4>
                                                            ¿Seguro que desea ELIMINAR la Unidad de Medida "<span style="color: Green;"><%# Eval("Nombre") %></span>"?
                                                        </h4>
                                                    </div>
                                ...
                                <EmptyItemTemplate>
                                    <div style="padding: 4px; border: solid 1px #86a6ca;">
                                        No existen Unidades de Medidas definidas!
                                    </div>
                                </EmptyItemTemplate>
                            </asp:ListView>
        ...
        <asp:ObjectDataSource ID="odsUnidadDeMedida" runat="server" OldValuesParameterFormatString="original_{0}"
            OnSelecting="odsUnidadDeMedida_Selecting" SelectMethod="Search" 
                TypeName="Interfood.Business.UnidadMedidaBus">
            <SelectParameters>
