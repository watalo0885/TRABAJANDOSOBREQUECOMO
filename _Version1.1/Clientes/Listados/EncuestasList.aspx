...
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_Body" runat="Server">
        ...
        <div style="padding: 2px;">
            ...
            <div id="cnt-listview">
                        ...
                        <asp:ListView ID="lvGeneric" runat="server" DataSourceID="odsEncuestas" OnItemDataBound="ItemDataBound_lvGeneric">
                            ...
                            <ItemTemplate>
                                <tr id="item" runat="server" class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                    ...
                                    <td align="center" style="text-align: center;">
                                        <img src="../../Images/excel.png" id="ImgXlsNutrientes" runat="server" alt="" title="Exportar Alimentos de Encuesta a Excel"
                                            style="border: 0px; cursor: hand; cursor: pointer;" />
                                    </td>
                                    <td align="center" style="text-align: center;">
                ...
                <div style="padding-top:20px;">
                    <div style="padding: 5px 10px; cursor: pointer; cursor: hand;" runat="server" id="AllExport"
                        onclick="window.open('../../GenerarXls.aspx?EncuestaNro=0&Listado=1');return false;"
                        title="Exportar todas las Encuesta de Alimentos a Excel">
                    ...
                    <div style="padding: 5px 10px; cursor: pointer; cursor: hand;" onclick="window.open('../../GenerarXls.aspx?EncuestaNro=0&Listado=2');return false;"
                        title="Exportar todas las Encuesta de Nutrientes a Excel">
                        <div style="width: 500px;">
                            <img src="../../Images/excel.png" id="ImgAllNutrientes" runat="server" alt="" style="border: 0px;
                                cursor: hand; cursor: pointer;" />
                            &nbsp; <span class="lbl-btnCrearUsuario">Exportar <b>NUTRIENTES</b> de TODAS las Encuestas</span>
                        </div>
                    </div>
                    <div style="padding: 5px 10px; cursor: pointer; cursor: hand;" onclick="window.open('../../GenerarXls.aspx?EncuestaNro=0&Listado=3');return false;"
                        title="Exportar todas las Encuesta de Nutrientes por Alimentos a Excel">
                        <div style="width: 500px;">
                            <img src="../../Images/excel.png" id="ImgAllAlimentosNutrientes" runat="server" alt=""
                                style="border: 0px; cursor: hand; cursor: pointer;" />
                            &nbsp; <span class="lbl-btnCrearUsuario">Exportar <b>ALIMENTOS / NUTRIENTES </b> de TODAS las Encuestas</span>
                        </div>
                    </div>
                </div>
                <div style="padding-top:20px;">
                    <div style="padding: 5px 10px; cursor: pointer; cursor: hand;" runat="server" id="Div1"
                        onclick="window.open('../../GenerarXls.aspx?EncuestaNro=0&Listado=1');return false;"
                        title="Exportar todas las Encuesta de Alimentos a Excel">
                        <div style="width: 500px;">
                    ...
                    <div style="padding: 5px 10px; cursor: pointer; cursor: hand;" onclick="window.open('../../GenerarXls.aspx?EncuestaNro=0&Listado=2');return false;"
                        title="Exportar todas las Encuesta de Nutrientes a Excel">
                        <div style="width: 500px;">
                            <img src="../../Images/excel.png" id="Img2" runat="server" alt="" style="border: 0px;
                                cursor: hand; cursor: pointer;" />
                    ...
                    <div style="padding: 5px 10px; cursor: pointer; cursor: hand;" onclick="window.open('../../GenerarXls.aspx?EncuestaNro=0&Listado=3');return false;"
                        title="Exportar todas las Encuesta de Nutrientes por Alimentos a Excel">
                        <div style="width: 500px;">
                            <img src="../../Images/excel.png" id="Img3" runat="server" alt=""
                                style="border: 0px; cursor: hand; cursor: pointer;" />
                            &nbsp; <span class="lbl-btnCrearUsuario">Exportar <b>Nueva disposicion de ALIMENTOS / NUTRIENTES </b> de TODAS las Encuestas</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <asp:ObjectDataSource ID="odsEncuestas" runat="server" OldValuesParameterFormatString="original_{0}"
        OnSelecting="odsEncuestas_Selecting" OnSelected="odsEncuestas_Selected" SelectMethod="Search"
        TypeName="Interfood.Business.vEncuestaHeaderBus">
        <SelectParameters>
