...
{
    public class Listado_NutrientesPorEncuestasEntityPaged
    {
        ...
        public Listado_NutrientesPorEncuestasEntityPaged()
        {
            try
            {
        ...
        public Listado_NutrientesPorEncuestasEntityPaged(int oPageSize, int oPageReturn)
        {
            try
            {
                this.pageSize = int.Parse(ConfigurationManager.AppSettings["PageSize"]);
