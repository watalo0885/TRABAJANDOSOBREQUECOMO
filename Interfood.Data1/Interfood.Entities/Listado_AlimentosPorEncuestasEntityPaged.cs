...
{
    public class Listado_AlimentosPorEncuestasEntityPaged
    {
        ...
        public Listado_AlimentosPorEncuestasEntityPaged()
        {
            try
            {
        ...
        public Listado_AlimentosPorEncuestasEntityPaged(int oPageSize, int oPageReturn)
        {
            try
            {
                this.pageSize = int.Parse(ConfigurationManager.AppSettings["PageSize"]);
