...
{
    public class Listado_NutrientesPorAlimentosEntityPaged
    {
        ...
        public Listado_NutrientesPorAlimentosEntityPaged()
        {
            try
            {
        ...
        public Listado_NutrientesPorAlimentosEntityPaged(int oPageSize, int oPageReturn)
        {
            try
            {
                this.pageSize = int.Parse(ConfigurationManager.AppSettings["PageSize"]);
