...
{
    public class vAlimentosDeEncuestasEntityPaged
    {
        ...
        public vAlimentosDeEncuestasEntityPaged()
        {
            try
            {
        ...
        public vAlimentosDeEncuestasEntityPaged(int oPageSize, int oPageReturn)
        {
            try
            {
                this.pageSize = int.Parse(ConfigurationManager.AppSettings["PageSize"]);
