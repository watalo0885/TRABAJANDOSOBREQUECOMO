...
{
    public class vAlimentoNutrienteParaAgregarEntityPaged
    {
        ...
        public vAlimentoNutrienteParaAgregarEntityPaged()
        {
            try
            {
        ...
        public vAlimentoNutrienteParaAgregarEntityPaged(int oPageSize, int oPageReturn)
        {
            try
            {
                this.pageSize = int.Parse(ConfigurationManager.AppSettings["PageSize"]);
