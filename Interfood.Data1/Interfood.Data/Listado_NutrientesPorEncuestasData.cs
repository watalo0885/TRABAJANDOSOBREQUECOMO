...
{
    public class Listado_NutrientesPorEncuestasData
    {
        ...
        public Listado_NutrientesPorEncuestasData()
        {
            this.DataBase = DatabaseFactory.CreateDatabase(InterfoodConfiguration.ConnectionStringNameInput);
        }

        public Listado_NutrientesPorEncuestasData(string NameConnection)
        {
        ...
        {
            DbCommand storedProcCommand = this.DataBase.GetStoredProcCommand("Listado_NutrientesPorEncuestas_Search");
            try
            {
        ...
        {
            DbCommand storedProcCommand = this.DataBase.GetStoredProcCommand("Listado_NutrientesPorEncuestas_SearchWithPagination");
            try
            {
                using (storedProcCommand)
                {
        ...
        {
            DbCommand storedProcCommand = this.DataBase.GetStoredProcCommand("Listado_NutrientesPorEncuestas_SearchCount");
            try
            {
                using (storedProcCommand)
                {
        ...
        {
            DbCommand storedProcCommand = this.DataBase.GetStoredProcCommand("Listado_NutrientesPorEncuestas_SearchCountWithPagination");
            try
            {
                using (storedProcCommand)
                {
        ...
        {
            DbCommand storedProcCommand = this.DataBase.GetStoredProcCommand("Listado_NutrientesPorEncuestas_GetAll");
            try
            {
                using (storedProcCommand)
                {
